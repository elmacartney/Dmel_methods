# Based on Allen & Bundenberg 2021. Habituation Learning Is a Widely Affected Mechanism in Drosophila Models of Intellectual Disability and Autism Spectrum Disorders. BiorXiv.
...
DEFINE TEMPERATURE 25				# set assay temperature
...
SET(AUTOREF_MODE,1)
SET(AUTOREF_TIMEOUT,300)				# sets the max time for detection of animals when initiating tracking
